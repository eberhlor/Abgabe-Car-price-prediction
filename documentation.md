...
> See *Data cleaning* in [`Prediction-Model-Car.ipynb`]([Prediction-Model-Car.ipynb](https://github.com/eberhlor/Abgabe-Car-price-prediction/blob/main/Abgabe/app.py#data-cleaning)
